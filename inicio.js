/* =================================================================================
   ARCHIVO: inicio.js
   MÓDULO DE INICIO Y BRANDING - DIGITAL WORLD ADMIN
   Lógica: Pantalla de bienvenida premium y actualización de Logo/Banner.
   ¡AHORA CON CARGA FLASH (CACHÉ LOCAL), SINCRONIZACIÓN EN SEGUNDO PLANO Y PARSEO SEGURO!
================================================================================= */
            ...
            <div class="inicio-hero">
                ...
                <div style="z-index: 1;">
                    ...
                    <p style="color: var(--text-gray); margin-top: 8px; font-size: 1.05rem; max-width: 600px;">
                        Bienvenido a <strong>Digital World</strong>. Desde aquí podrás gestionar el catálogo, monitorear los ingresos y personalizar la experiencia visual de tus clientes.
                    </p>
                </div>
            </div>
...
async function cargarBrandingUltraRapido() {
    ...
    try {
        ...
        fetch('https://api-ventas-zzd6.onrender.com/admin_api.php', {
            method: 'POST',
...
window.subirImagenBranding = async function(tipo) {
    ...
    try {
        ...
        const response = await fetch('https://api-ventas-zzd6.onrender.com/admin_api.php', {
            method: 'POST',
            body: formData 
        });
