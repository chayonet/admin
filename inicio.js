            ...
            <div class="inicio-hero">
                ...
                <div style="z-index: 1;">
                    ...
                    <p style="color: var(--text-gray); margin-top: 8px; font-size: 1.05rem; max-width: 600px;">
                        Bienvenido a <strong>CHAYONET</strong>. Desde aquí podrás gestionar el catálogo, monitorear los ingresos y personalizar la experiencia visual de tus clientes.
                    </p>
                </div>
            </div>
